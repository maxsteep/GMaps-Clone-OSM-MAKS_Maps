...
////this will allowed text been draw on the screen witch ancker at the very left of the text
//void drawtext_left(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX);
